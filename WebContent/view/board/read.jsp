...
<t:commonLayout>
	<jsp:body>
		...
		<hr class="bg-light" />
  		<div class="row">
	  		...
	  		<strong>${dto.writerNickname }</strong>
	  		</div>
	  		<div class="col-7">
		...
		<c:if test="${dto.writerNo == currentDto.no }">
	...
	// $(document).ready( 무엇을 할 지 ); // Document 가 모두 ready 되었을 때 (로드되었을 때)
	// $("#x").click( 무엇을 할 지 ); //  id가 x인 element 의 onclick 리스너 등록
